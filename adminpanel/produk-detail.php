    ...
    <div class="container">
        ...
        <div class="col-12 col-md-6 mb-5">
            ...
            ?>
                    ...
                    ?>
                            <div class="alert alert-warning mt-3" role="alert">
                                File minimal di bawah 500kb
                            </div>
                            <?php
                        } else {
                            if ($imageFileType != 'jpg' && $imageFileType != 'png' && $imageFileType != 'jfif' && $imageFileType != 'gif') {
             ?>
                                <div class="alert alert-warning mt-3" role="alert">
                                    File harus bertipe PNG or JPG
                                </div>
            <?php
                            }
                            else{
                                ...
                                if ($queryUpdate) {
            ?>
                                        <div class="alert alert-primary mt-3" role="alert">Produk Berhasil di Update</div>
            ...
            if(isset($_POST['hapus'])){
                ...
                if($queryHapus){
                    ?>
                    <div class="alert alert-warning mt-3" role="alert">Berhasil diHapus</div>
                    <meta http-equiv="refresh" content="2; url=produk.php" >
                    <?php
                }
            }
